...
const metricGroup = project.getMetricGroup("ecozonesPelagicOverlap");
...
export const EcozonesPelagicCard = () => {
  ...
  return (
    <>
      <ResultsCard
        title={t("Pelagic Ecozones")}
        functionName="ecozonesPelagicOverlap"
        useChildCard
      >
        {(data: ReportResult) => {
          ...
          return (
            <ToolbarCard
              title={t("Pelagic Ecozones (Southern Shelf)")}
              items={
                <LayerToggle
                  label={mapLabel}
            ...
            >
              ...
              <Collapse title={t("Learn more")}>
                <Trans i18nKey="Priority Areas Card - learn more">
                  <p>
                    {" "}
                    This report summarizes the proportion of pelagic ecozones
                    within this plan.
                  </p>
                  <p>
