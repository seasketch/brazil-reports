...
/**
 * bathyClassesWorker: A geoprocessing function that calculates overlap metrics
 * @param sketch - A sketch or collection of sketches
 * @param extraParams
 * @returns Calculated metrics and a null sketch
 */
export async function bathyClassesWorker(
  sketch:
...
export default new GeoprocessingHandler(bathyClassesWorker, {
  title: "bathyClassesWorker",
  description: "",
  timeout: 500, // seconds
